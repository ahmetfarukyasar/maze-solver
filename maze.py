...
class Maze():
    ...
    def solve(self, algorithm="dfs"):
        ...
        # Choose frontier type based on algorithm
        if algorithm.lower() == "dfs":
            frontier = StackFrontier()
            print(f"Using Depth-First Search (DFS)")
        elif algorithm.lower() == "bfs":
            frontier = QueueFrontier()
            print(f"Using Breadth-First Search (BFS)")
        else:
            raise Exception("Algorithm must be 'dfs' or 'bfs'")
